 ...
 * post请求加载进度
 */
public class ProgressReqFrameDialog extends Dialog {

    private TextView tvPost;

    public ProgressReqFrameDialog(Context context) {
        super(context, R.style.dialog_activity_theme);
    }

    public ProgressReqFrameDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected ProgressReqFrameDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
