 ...
 * @author Bamboy
 */
public class BamFrameLayout extends AutoFrameLayout {
    ...
    public BamFrameLayout(Context context) {
        this(context, null);
        init(context, null);
    }

    public BamFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public BamFrameLayout(Context context, AttributeSet attrs, int defStyle) {
