 ...
 */
public class BamRoundedImgView extends RoundedImageView {

    private boolean superb = false;
    private int pivot = 0;

    public BamRoundedImgView(Context context) {
        this(context, null);
        init(context, null);
    }

    public BamRoundedImgView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public BamRoundedImgView(Context context, AttributeSet attrs, int defStyleAttr) {
