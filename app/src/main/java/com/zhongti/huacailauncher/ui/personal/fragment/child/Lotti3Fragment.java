 ...
 */
public class Lotti3Fragment extends BaseSupportFragment<PrivatePresenter> implements PrivateContract.View {
    private View rootView;
    @BindView(R.id.rv_private_lotti_child)
    RecyclerView recycler;

    public static Lotti3Fragment newInstance() {

        Bundle args = new Bundle();

        Lotti3Fragment fragment = new Lotti3Fragment();
    ...
    public void onSupportVisible() {
        ...
        if (mPresenter != null) mPresenter.reqLottiPostList();
    }

    @Override
    public void setLotti3Adapter(PrivateLotti3Adapter adapterLotti3) {
        recycler.setAdapter(adapterLotti3);
    }
}
