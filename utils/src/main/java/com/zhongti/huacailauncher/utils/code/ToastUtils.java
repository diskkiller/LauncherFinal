...
public final class ToastUtils {
     ...
     * @param text 文本
     */
    public static void showMyShort(@NonNull final CharSequence text, int xOffset, int yOffset) {
        setGravity(Gravity.CENTER_VERTICAL | Gravity.START, xOffset, yOffset);
        show(text, Toast.LENGTH_SHORT);
    }
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                ...
                sToast.setGravity(Gravity.START | Gravity.BOTTOM, 68, -40);
                setBg();
                sToast.show();
            }
        });
