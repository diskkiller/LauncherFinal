...
public class Keyboard2Utils implements ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    private static HashMap<SoftKeyboardToggleListener, Keyboard2Utils> sListenerMap = new HashMap<>();
    ...
    public static void addKeyboardToggleListener(Activity act, SoftKeyboardToggleListener listener)
    {
        ...
        sListenerMap.put(listener, new Keyboard2Utils(act, listener));
    }
    ...
    public static void removeKeyboardToggleListener(SoftKeyboardToggleListener listener)
    {
        ...
        {
            Keyboard2Utils k = sListenerMap.get(listener);
            k.removeListener();
    ...
    private Keyboard2Utils(Activity act, SoftKeyboardToggleListener listener)
    {
        mCallback = listener;
